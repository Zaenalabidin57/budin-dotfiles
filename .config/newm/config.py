...
def key_bindings(layout: Layout) -> list[tuple[str, Callable[[], Any]]]:
    return [
        ...
        ("L-Return", lambda: os.system("ghostty &")),
        ("L-D", lambda: os.system("fuzzel &")),
        ("L-O", lambda: os.system("zen-browser &")),
...
panels = {
    'lock': {
        'cmd': 'ghostty -e newm-panel-basic lock',
    },
    'launcher': {
        'cmd': 'ghostty -e newm-panel-basic launcher'
    },
    'top_bar': {
        'native': {
            'enabled': True,
